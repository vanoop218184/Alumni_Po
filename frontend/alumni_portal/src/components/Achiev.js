    ...
    <div className="flex justify-center m-4">
      <div className="w-full md:w-11/12 lg:w-10/12 xl:w-8/12">
        ...
        <div className="flex justify-center mt-8">
          <a
            className="bg-blue-950 hover:bg-slate-50 border-[1px] border-blue-950 text-white hover:text-blue-950 py-3 px-8 rounded-lg shadow-lg transition duration-300 ease-in-out text-xl font-bold"
            href={link}
          >
            More Connections
          </a>
