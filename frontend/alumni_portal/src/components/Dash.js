      ...
      <div className="flex justify-center bg-white">
        <div className="w-11/12 h-auto space-x-7 flex flex-row items-center">
          ...
          <div className=" w-1/2 rounded-lg bg-slate-50 font-serif m-5 p-5 border-2 border-slate-300 shadow-xl flex flex-col">
            <p>
              Hello Alumni,Here you'll find two important buttons to help you
              stay engaged and up-to-date. If you have any referrals or job
              openings to share, please click on the{" "}
            ...
            >
              <Link to="/update">
                <button className="bg-blue-950 font-bold font-sans text-white hover:bg-white border-[1px] shadow-xl border-blue-600 hover:text-blue-600 rounded-lg p-2 m-1 hover:scale-1/2">
                  Edit Profile
                </button>
              </Link>
              {user.batch < currentyear ? (
                <Link to="/addjob">
                  {" "}
                  <button className="bg-blue-950 font-bold font-sans text-white hover:bg-white border-[1px] shadow-xl hover:border-blue-600 hover:text-blue-600 rounded-lg p-2 m-1 ">
                    {" "}
                    Add new Openings
                  </button>
                </Link>
