    ...
    <>
      <div className="flex justify-center p-6 sm:py-3 hover:scale-105  ">
        <div className="bg-white border-2 border-gray-600 shadow-xl  w-full max-w-4xl flex flex-col sm:flex-row md:flex-row lg:flex-row xl:flex-row  gap-3  justify-between px-5 py-4 rounded-md">
          ...
          <a href={item.link}><button className=" flex  items-center p-2  rounded-md text-blue-950  bg-slate-50 hover:text-white hover:bg-blue-950 font-bold hover:scale-105 border-blue-950 border-[1px] hover:border-slate-50 left-2  flex-nowrap shadow-lg">
              Apply Now
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
