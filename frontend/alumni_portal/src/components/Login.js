        ...
        <div className="modal-box  dark:bg-slate-900 dark:text-white">
          <form method="dialog ">
            ...
            <div className="flex justify-between mt-4">
              <button
                className="btn btn-primary  text-blue-950 hover:text-white hover:bg-blue-950 bg-slate-50 font-bold hover:scale-105 border-blue-950 border-[1px] hover:border-slate-50 left-2 "
                onClick={handleLogin}
              >
                Login
              </button>
