...
function Navbar() {
  ...
  return (
    <>
      <div className="navbar h-3 w-100% bg-blue-950 flex flex-row space-x-5 justify-between sticky top-0 z-20 ">
        <div>
          <Link to="/" className="flex ">
            <img
              ...
              alt=" silchar"
            />
            <p className="bg-blue-950 font-extrabold font-serif text-white text-3xl  rounded-lg p-2 m-1 hover:scale-1/2">
              Aluminati
            </p>
          </Link>
        </div>
        ...
        <div>
          <div>
            <div className="dropdown text-slate-50">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-blue-950 text-white font-bold rounded-lg w-[130px]  "
              >
